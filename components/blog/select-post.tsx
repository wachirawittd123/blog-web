...
export const SelectPostComponent: React.FC<ISelectComponent> = ({ onChange, value, options, width = "auto" }) => {
        ...
        <div className="relative">
            <div
                className={`
                    ...
                    lg:w-[200px] sm:w-auto border-[#49A569] border-2 rounded-md
                `}
            ...
            {isOpen && (
                <div 
                    className={`
                        ...
                        ${windowWidth < 768 ? "w-[200px] right-[-10px]" : "left-0 min-w-xs"}
                    `}
                >
                    <ul>
